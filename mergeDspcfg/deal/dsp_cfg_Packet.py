# 参照Qboot的头编写DSP数据的头文件
import sys
import struct
import time
import zlib

class dsp_cfg_Packet: 
    def __init__(self, packet_type, algo, algo2, time_stamp, part_name, fw_ver, prog_code, dsp_grp_size, dsp_grp_crc,
                 dsp_cfg_size, dsp_cfg_crc):
        ...
        self.dsp_grp_crc = dsp_grp_crc            #DSP_CFG CRC
        self.dsp_cfg_crc = dsp_cfg_crc            #打包CRC
        self.dsp_cfg_size = dsp_cfg_size          #打包尺寸   
        self.dsp_grp_size = dsp_grp_size          #固件尺寸                 
